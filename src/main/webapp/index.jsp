<html>
<head>
<title>Our Devices Shop:)</title>																																																						<html>
</head>

   <body>

      Select your action, please:<br/><br/>
      <a href="#" onclick="performAction('show', 'customers')"> View list of customers  </a>
      <br/>
      <a href="#" onclick="performAction('show', 'products')"> View list of products </a>
      <br/>
      <a href="#" onclick="performAction('show', 'purchases')"> View purchases </a>
      <br/>
      <br/>
      <div id="history"></div>
   </body>
...
performAction = function(assistantGesture, subject) {
	console.log("************** Web shop action *****************");
   ...
   **/
   renderOut(assistantGesture, subject);

}


renderOut = function(assistantGesture, subject){
	console.log("************** RENDERING RESULT *****************");
	let output = "<table><tr><th>Action</th><th>Subject</th></tr>";
    output = output + " <tr>";
    output = output + " <td> " + assistantGesture + " </td> ";
    output = output + " <td> " + subject  + " </td> ";
    output = output + " </tr>";
    console.log(output);
    output = output + "</table>";
